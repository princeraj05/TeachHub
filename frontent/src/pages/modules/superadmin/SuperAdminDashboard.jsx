  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B0F19] text-slate-900 dark:text-slate-100 p-4 md:p-8 font-sans transition-colors duration-200">
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Super Admin Workspace</h1>
          <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Overview of platform metrics, active institutions, and recent database events.</p>
        </div>
        <button
          onClick={fetchDashboardStats}
          className="flex items-center gap-2 bg-white dark:bg-[#131B2E] hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 text-xs font-bold px-4 py-2.5 rounded-xl transition-all shadow-md self-start md:self-auto"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="bg-white dark:bg-[#131B2E] border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-lg flex items-center justify-between">
          <div>
        ...
        <div className="bg-white dark:bg-[#131B2E] border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-lg flex items-center justify-between">
          <div>
            ...
            <button
              ...
              className="text-xs text-amber-600 dark:text-amber-400/90 hover:underline font-medium mt-1 inline-block"
            >
              Requires review →
            </button>
          </div>
        ...
        <div className="bg-white dark:bg-[#131B2E] border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-lg flex items-center justify-between">
          <div>
            ...
            <span className="text-xs text-emerald-600 dark:text-emerald-400 font-medium mt-1 inline-block">Active Institutions</span>
          </div>
        ...
        <div className="bg-white dark:bg-[#131B2E] border border-purple-500/30 rounded-2xl p-5 shadow-lg flex items-center justify-between relative overflow-hidden">
          <div className="absolute top-0 right-0 w-24 h-24 bg-purple-500/5 rounded-full blur-xl pointer-events-none" />
          <div>
            <p className="text-[10px] font-bold text-purple-600 dark:text-purple-400 uppercase tracking-widest">Super Admin Revenue</p>
            ...
            <span className="text-xs text-purple-600 dark:text-purple-400/80 font-medium mt-1 inline-block">Actual SaaS / Subs Revenue</span>
          </div>
          <div className="w-12 h-12 rounded-xl bg-purple-500/10 border border-purple-500/30 flex items-center justify-center text-purple-600 dark:text-purple-400 text-xl shadow-inner">
            <FaDollarSign />
          </div>
        </div>
      </div>
      ...
      {stats?.financials?.schoolRevenueBreakdown && stats.financials.schoolRevenueBreakdown.length > 0 && (
        <div className="bg-white dark:bg-[#131B2E] border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-xl mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4 pb-4 border-b border-slate-200 dark:border-slate-800">
            <div>
              <h3 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2">
                ...
                <span className="text-xs font-semibold px-2.5 py-0.5 rounded-full bg-purple-500/20 text-purple-700 dark:text-purple-300 border border-purple-500/30">Super Admin Special</span>
              </h3>
            ...
            <div className="bg-slate-50 dark:bg-[#0B0F19] px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center gap-3">
              <span className="text-xs text-slate-600 dark:text-slate-400 font-medium">Total System Volume:</span>
              <span className="text-sm font-extrabold text-emerald-600 dark:text-emerald-400">₹{(stats?.financials?.totalSystemVolume || 0).toLocaleString()}</span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-[#131B2E] border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-xl">
          <h3 className="text-base font-bold text-slate-900 dark:text-white mb-4">Quick Actions</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <button
              onClick={() => navigate("/superadmin/users?status=Pending")}
              className="p-4 rounded-xl bg-slate-50 dark:bg-[#0B0F19] hover:bg-slate-100 dark:hover:bg-slate-800/70 border border-slate-200 dark:border-slate-700/60 transition-all text-left group"
            >
              <p className="text-sm font-bold text-blue-600 dark:text-blue-400 group-hover:text-blue-500 dark:group-hover:text-blue-300 flex items-center justify-between">
                <span>Approve Users</span>
                <FaArrowRight className="text-xs group-hover:translate-x-1 transition-transform" />
              </p>
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">Review pending user registrations</p>
            </button>
            ...
            <button
              ...
              className="p-4 rounded-xl bg-slate-50 dark:bg-[#0B0F19] hover:bg-slate-100 dark:hover:bg-slate-800/70 border border-slate-200 dark:border-slate-700/60 transition-all text-left group"
            >
              <p className="text-sm font-bold text-emerald-600 dark:text-emerald-400 group-hover:text-emerald-500 dark:group-hover:text-emerald-300 flex items-center justify-between">
                <span>Manage Schools</span>
                <FaArrowRight className="text-xs group-hover:translate-x-1 transition-transform" />
              </p>
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">View list & configure settings</p>
            </button>
            ...
            <button
              ...
              className="p-4 rounded-xl bg-slate-50 dark:bg-[#0B0F19] hover:bg-slate-100 dark:hover:bg-slate-800/70 border border-slate-200 dark:border-slate-700/60 transition-all text-left group"
            >
              <p className="text-sm font-bold text-amber-600 dark:text-amber-400 group-hover:text-amber-500 dark:group-hover:text-amber-300 flex items-center justify-between">
                <span>Notifications</span>
                <FaArrowRight className="text-xs group-hover:translate-x-1 transition-transform" />
              </p>
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">System alerts & platform logs</p>
            </button>
            ...
            <button
              ...
              className="p-4 rounded-xl bg-slate-50 dark:bg-[#0B0F19] hover:bg-slate-100 dark:hover:bg-slate-800/70 border border-slate-200 dark:border-slate-700/60 transition-all text-left group"
            >
              <p className="text-sm font-bold text-purple-600 dark:text-purple-400 group-hover:text-purple-500 dark:group-hover:text-purple-300 flex items-center justify-between">
                <span>Support Inbox</span>
                <FaArrowRight className="text-xs group-hover:translate-x-1 transition-transform" />
              </p>
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">Manage user tickets & chats</p>
            </button>
          </div>
        </div>

        <div className="bg-white dark:bg-[#131B2E] border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-xl">
          <h3 className="text-base font-bold text-slate-900 dark:text-white mb-4">Recent Database Activity</h3>
