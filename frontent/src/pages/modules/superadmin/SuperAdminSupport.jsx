  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] text-slate-100 p-4 md:p-8 font-sans flex flex-col">
      ...
      <div className="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-white tracking-tight">Super Admin Support Workspace</h1>
          <p className="text-sm text-slate-400 mt-1">Direct video calls, voice calls, file sharing & chat with School Admins.</p>
        </div>
        <button
      ...
      <div className="bg-[#131B2E] border border-slate-800 rounded-2xl overflow-hidden shadow-2xl flex flex-col md:flex-row flex-1 h-[calc(100vh-220px)] min-h-[600px]">
        ...
        <div className="w-full md:w-80 border-b md:border-b-0 md:border-r border-slate-800 flex flex-col bg-[#131B2E]">
          ...
          <div className="p-3.5 border-b border-slate-800 bg-[#0B0F19]/50 flex items-center justify-between">
            ...
            <span className="text-[11px] font-semibold bg-blue-500/20 text-blue-300 px-2 py-0.5 rounded-full">
          ...
          <div className="flex-1 overflow-y-auto divide-y divide-slate-800/60">
            {filteredContacts.length === 0 ? (
              <div className="p-8 text-center text-slate-500">
                <FaUserTie className="text-2xl mx-auto mb-2 text-slate-600" />
                  ...
                  >
                    <div className="relative flex-shrink-0">
                      ...
                      <span
                        className={`absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full border-2 border-[#131B2E] ${
                          admin.isOnline ? "bg-emerald-500" : "bg-slate-500"
                        }`}
                      />
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        <h4 className="text-xs font-bold truncate text-white">{admin.name}</h4>
