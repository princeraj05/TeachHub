...
function TeacherLayout() {
  ...
  const navLinks = [
    ...
    { to: "/teacher/support", icon: <FaComments className="text-[#38BDF8]" />, label: t("support", "Help & Support") },
    { to: "/teacher/support-team", icon: <FaHeadset className="text-[#7C3AED]" />, label: t("support_team", "Support Team") },
