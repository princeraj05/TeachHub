...
const MOCK_UPCOMING = [
  ...
  },
  {
    ...
    daysLeftStatic: 26,
    themeColor: "emerald",
    avatarBg: "bg-emerald-950/15 border border-emerald-500/20 text-emerald-555",
  ...
  },
  {
    ...
    illustration: (
      <svg className="w-8 h-8 sm:w-10 sm:h-10" viewBox="0 0 36 36" fill="none">
        ...
        <path d="M15 21l-3 5 4 4" stroke="#0EA5E9" strokeWidth="2.5" strokeLinecap="round" />
...
const MOCK_COMPLETED = [
  {
    ...
    title: "Independence Day Celebration",
    description: "Celebrated 78th Independence Day with flag hoisting, cultural programs and more.",
    subtitle: "Celebration",
    eventDate: "2026-08-15T00:00:00.000Z",
    eventTime: "9:00 AM",
    location: "School Ground",
