...
function StudentSupport() {
  ...
  useEffect(() => {
    ...
    socket.on("support:new-message", (msg) => {
      ...
      // If broadcast message targeting students
      if (msg.type === "broadcast" && msg.targetRole === "student") {
        ...
        {activeTab === "teachers" && (
          <div className="flex-1 flex">
            ...
            <div className="w-1/3 border-r border-slate-100 flex flex-col h-full bg-slate-50/50">
              <div className="p-4 border-b border-slate-100 bg-white select-none">
                <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider flex items-center gap-1.5">
                  <FaComments className="text-[#7C3AED]" /> Teachers Directory
                </h3>
              </div>
                ...
                <>
                  <div className="p-4 border-b border-slate-100 bg-white z-10 flex items-center gap-3 select-none">
                    ...
                    <div>
                      ...
                      <span className="text-[9px] text-slate-450 font-bold uppercase tracking-wider block mt-0.5">Teacher Chat</span>
                    </div>
                  </div>
