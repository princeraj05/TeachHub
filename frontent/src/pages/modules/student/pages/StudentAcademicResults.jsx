            ...
            return (
              ...
              >
                ...
                <div className="p-5 sm:p-6 overflow-x-auto">
                  <h4 className="text-xs font-black text-slate-700 dark:text-slate-200 uppercase tracking-wider mb-3">
                          ...
                          return (
                            <tr key={sub.subjectId || sIdx} className="hover:bg-slate-50/60 dark:hover:bg-white/[0.02]">
                              ...
                              <td className="py-3.5 px-4 text-center">
                                {isSubAbsent ? (
                                  <span className="px-2 py-0.5 rounded bg-rose-500/10 text-rose-600 dark:text-rose-400 font-extrabold text-[10px]">
                                    ABSENT
                                  </span>
                                ) : (
                              ...
                              <td className="py-3.5 px-4 text-center font-extrabold text-slate-800 dark:text-white">
                                {isSubAbsent ? "0 (AB)" : sub.marksObtained}
                              </td>
                              <td className="py-3.5 px-4 text-center text-slate-500 dark:text-slate-400">
                                {sub.maxMarks}
                              </td>
                              <td className="py-3.5 px-4 text-center font-black text-[#7C3AED] dark:text-[#38BDF8]">
                ...
                {/* Teacher Remarks Footer */}
                {result.teacherRemarks && (
                  <div className="p-4 sm:p-5 bg-amber-500/5 border-t border-amber-500/10 text-xs">
                    <p className="font-black text-amber-700 dark:text-amber-400 uppercase tracking-wider text-[10px] mb-0.5">
