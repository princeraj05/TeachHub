...
import { FaBell, FaCheckDouble, FaTrashAlt, FaFilter, FaSearch, FaExternalLinkAlt } from "react-icons/fa";
...
export default function AdminNotifications() {
  ...
  const categories = ["All", "Join Request", "Attendance", "Exams", "Events", "System", "Leave", "Support"];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-[#0B132A] p-5 rounded-2xl border border-slate-200 dark:border-white/10 shadow-xs">
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-black tracking-tight text-slate-800 dark:text-white">Admin Notification Center</h1>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Real-time alerts, join requests, and school activity updates</p>
            </div>
          </div>
        </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-4 mt-3 text-[11px] text-slate-400 font-semibold">
                    ...
                    {n.link && (
                      ...
                      >
                        Action Link <FaExternalLinkAlt className="text-[9px]" />
                      </button>
                    )}
                  </div>
                </div>
