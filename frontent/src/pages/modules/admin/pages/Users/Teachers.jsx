    ...
    <div style={{ fontFamily: "'Sora', sans-serif" }}>
      ...
      <div className="mb-7 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">All registered teachers in TeachHub</p>
        </div>
        <div className="flex items-center gap-2 bg-teal-50 border border-teal-100 rounded-2xl px-4 py-2.5 w-fit">
          ...
          <span className="text-sm font-bold text-teal-700">{teachers.length} Teachers</span>
        </div>
      </div>
      ...
      <div className="sm:hidden space-y-3">
        {filtered.length === 0 ? (
          <div className="bg-white rounded-2xl border border-slate-200 py-14 text-center shadow-sm">
            <FaChalkboardTeacher className="text-slate-300 text-4xl mx-auto mb-3" />
          ...
          filtered.map((t, i) => (
            ...
            >
              {/* top accent */}
              <div className={`h-1 w-full bg-gradient-to-r ${avatarColors[i % avatarColors.length]}`} />
              <div className="p-4 flex items-center gap-4">
                ...
                <span className="ml-auto flex-shrink-0 inline-flex items-center gap-1 bg-teal-50 text-teal-700 text-xs font-bold px-2.5 py-1 rounded-full">
      ...
      <div className="hidden sm:block bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
          <h2 className="text-base font-bold text-slate-800">All Teachers</h2>
          <span className="text-xs font-semibold bg-teal-50 text-teal-600 px-3 py-1 rounded-full border border-teal-100">
          ...
          <table className="min-w-full">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-100">
                ...
                <th className="px-6 py-3.5 text-left text-xs font-bold text-slate-400 uppercase tracking-wider">Teacher</th>
              ...
              {filtered.length === 0 ? (
                <tr>
                  <td colSpan="4" className="py-16 text-center">
                    <FaChalkboardTeacher className="text-slate-300 text-4xl mx-auto mb-3" />
                    <p className="text-slate-400 text-sm font-semibold">No teachers found</p>
