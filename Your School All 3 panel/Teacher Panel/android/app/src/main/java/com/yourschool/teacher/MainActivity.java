package com.yourschool.teacher;
...
public class MainActivity extends BridgeActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.bridge != null && this.bridge.getWebView() != null) {
            ...
            // Attach Native Download Manager & Base64 File Storage Listener to Teacher Capacitor WebView
            webView.setDownloadListener(new DownloadListener() {
                ...
                public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength) {
                    try {
                        ...
                        request.setDescription("Downloading file from Teacher Panel...");
    ...
    private void handleBase64DataDownload(String dataUrl, String contentDisposition, String mimeType) {
        try {
            ...
            String fileName = "Teacher_Doc_" + System.currentTimeMillis() + extension;
            fileName = fileName.replaceAll("[^a-zA-Z0-9._-]", "_");
