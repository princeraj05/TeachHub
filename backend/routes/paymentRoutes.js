...
router.get("/payment-settings", protect, authorize("superadmin", "admin", "teacher", "unassigned"), payment.getSettings);
router.put("/payment-settings", protect, authorize("superadmin", "admin", "teacher", "unassigned"), payment.updateSettings);
router.get("/admin/fee-plan", protect, authorize("admin", "unassigned"), payment.getFeePlan);
router.put("/admin/fee-plan", protect, authorize("admin", "unassigned"), payment.setFeePlan);
