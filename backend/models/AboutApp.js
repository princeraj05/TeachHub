...
const aboutAppSchema = new mongoose.Schema({
  ...
  // Legal Links
  privacyPolicyUrl: { type: String, default: "https://teachhub.app/privacy-policy" },
  cookiePolicyUrl: { type: String, default: "https://teachhub.app/cookie-policy" },
  termsOfServiceUrl: { type: String, default: "https://teachhub.app/terms-of-service" },
  disclaimerUrl: { type: String, default: "https://teachhub.app/disclaimer" },
  refundPolicyUrl: { type: String, default: "https://teachhub.app/refund-policy" },
  aboutUsUrl: { type: String, default: "https://teachhub.app/about-us" },
